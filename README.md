...
[Features](#-features) • [Installation](#-installation) • [Usage](#-usage) • [Menu Options](#-menu-options) • [FAQ](#-faq)
...
1. **Download** the `MirrorX_Optimizer.bat` file
2. **Save** it to any folder (e.g., `C:\Tools\`)
...
<details>
<summary><b>❓ "Access Denied" errors during cleanup</b></summary>

**Solution:** Ensure you're running the script as Administrator. Right-click → Run as Administrator.
</details>

<details>
<summary><b>❓ Script closes immediately after opening</b></summary>
...
<details>
<summary><b>❓ 'wmic' is not recognized error</b></summary>
